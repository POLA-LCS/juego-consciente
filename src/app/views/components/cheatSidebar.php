    ...
    <div class="space-y-4">
        <div class="space-y-2">
            <label for="cheatAmountInput"
                class="block text-sm font-medium mb-2 text-[var(--color-text-muted)]">Establecer monto</label>
        ...
        <div class="space-y-2">
            <div class="flex items-center justify-between">
                <label for="maxStreakToggle" class="text-sm font-medium text-[var(--color-text-muted)]">Máxima
                    Racha</label>
                <label class="switch"><input type="checkbox" id="maxStreakToggle"><span
                        class="slider round"></span></label>
            </div>
            <input type="number" id="maxStreakInput" name="maxStreak"
                class="w-full px-3 py-2 bg-[var(--color-surface)] border border-[var(--color-border)] rounded-md focus:outline-none focus:ring-2 focus:ring-[var(--color-primary)]"
                placeholder="Nº de victorias" disabled>
        </div>

        <div class="space-y-2">
            <div class="flex items-center justify-between">
                <label for="maxBalanceToggle" class="text-sm font-medium text-[var(--color-text-muted)]">Máximo
                    Saldo</label>
                <label class="switch"><input type="checkbox" id="maxBalanceToggle"><span
                        class="slider round"></span></label>
            </div>
            <input type="number" id="maxBalanceInput" name="maxBalance"
                class="w-full px-3 py-2 bg-[var(--color-surface)] border border-[var(--color-border)] rounded-md focus:outline-none focus:ring-2 focus:ring-[var(--color-primary)]"
                placeholder="Monto" disabled>
        </div>
    </div>
</aside>

<script src="assets/js/cheat_sidebar.js"></script>