...
require_once SRC_PATH . 'app/controllers/UserController.php';
    ...
    <main class="p-8 flex-1">
        <div class="max-w-lg mx-auto">
            ...
            <div class="bg-[var(--color-surface)] border border-[var(--color-border)] p-6 rounded-lg shadow-lg mb-10 flex items-center space-x-6">
                <img src="assets/images/logo.png" alt="Foto de perfil" class="h-24 w-24 rounded-full border-2 border-[var(--color-primary)]">
                <div>
                ...
                <a href="?action=logout" class="block text-center animated bg-red-900/30 border border-red-500 rounded-lg shadow-lg cursor-pointer overflow-hidden p-4 text-lg font-bold text-red-400 hover:bg-red-900/50 transition-colors">Cerrar Sesión</a>
            </div>
