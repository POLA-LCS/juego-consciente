...
<body>
    ...
    <main class="p-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 max-w-6xl mx-auto center-grid">
            <!-- Tarjeta de Juego -->
            <div class="game-card bg-gray-800 rounded-lg shadow-lg cursor-pointer overflow-hidden group" onclick="window.location.href='?page=blackjack'">
                <div class="relative h-80">
                    <img src="/ludopatia/public/assets/images/card.jpg" alt="Blackjack" class="w-full h-full object-cover">
                    <div class="absolute inset-0 bg-black bg-opacity-60"></div>
                    <div class="absolute inset-0 flex items-center justify-center">
                        <h2 class="text-3xl font-bold text-red-500 group-hover:text-red-400 transition-colors">Blackjack</h2>
                    </div>
                </div>
            </div>
            <div class="game-card bg-gray-800 rounded-lg shadow-lg cursor-pointer overflow-hidden group" onclick="window.location.href='?page=cups'">
                <div class="relative h-80">
                    <img src="/ludopatia/public/assets/images/card.jpg" alt="Cups Game" class="w-full h-full object-cover">
                    <div class="absolute inset-0 bg-black bg-opacity-60"></div>
                    <div class="absolute inset-0 flex items-center justify-center">
                        <h2 class="text-3xl font-bold text-red-500 group-hover:text-red-400 transition-colors">Cups Game</h2>
                    </div>
                </div>
            </div>
            <div class="game-card bg-gray-800 rounded-lg shadow-lg cursor-pointer overflow-hidden group" onclick="window.location.href='?page=roulette'">
                <div class="relative h-80">
                    <img src="/ludopatia/public/assets/images/card.jpg" alt="Roulette" class="w-full h-full object-cover">
                    <div class="absolute inset-0 bg-black bg-opacity-60"></div>
                    <div class="absolute inset-0 flex items-center justify-center">
                        <h2 class="text-3xl font-bold text-red-500 group-hover:text-red-400 transition-colors">Roulette</h2>
                    </div>
                </div>
            </div>
            <div class="game-card bg-gray-800 rounded-lg shadow-lg cursor-pointer overflow-hidden group" onclick="window.location.href='?page=slots'">
                <div class="relative h-80">
                    <img src="/ludopatia/public/assets/images/card.jpg" alt="Slots" class="w-full h-full object-cover">
                    <div class="absolute inset-0 bg-black bg-opacity-60"></div>
                    <div class="absolute inset-0 flex items-center justify-center">
                        <h2 class="text-3xl font-bold text-red-500 group-hover:text-red-400 transition-colors">Slots</h2>
                    </div>
                </div>
            </div>
        </div>
