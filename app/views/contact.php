...
<body>
    ...
    <div class="max-w-2xl mx-auto">
        ...
        <div class="bg-[var(--color-surface)] border border-[var(--color-border)] p-6 rounded-lg shadow-lg mb-6">
            ...
            <div class="mb-4">
                <h3 class="text-xl font-bold mb-2 text-red-500">Líneas de Ayuda</h3>
            ...
            <div class="mb-4">
                <h3 class="text-xl font-bold mb-2 text-red-500">Organizaciones Internacionales</h3>
                <ul class="list-disc list-inside">
                    <li>Gamblers Anonymous: <a href="https://www.gamblersanonymous.org/" class="text-red-500 hover:underline">www.gamblersanonymous.org</a></li>
        ...
        <div class="bg-[var(--color-surface)] border border-[var(--color-border)] p-6 rounded-lg shadow-lg">
            ...
            <form>
                <div class="mb-4">
                    ...
                    <input type="text" id="name" name="name" class="w-full px-3 py-2 bg-gray-700 border border-gray-600 rounded-md focus:outline-none focus:ring-2 focus:ring-red-500" required>
                </div>
                <div class="mb-4">
